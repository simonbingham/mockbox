...
component{
	...
	function init(){ 
		variables.converter = new mockbox.system.core.conversion.XMLConverter();
		return this; 
	}
	...
	*/
	any function runReport( 
		required mockbox.system.testing.TestResult results,
		required mockbox.system.testing.TestBox testbox,
		struct options={} 
	){
