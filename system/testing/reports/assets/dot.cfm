...
<head>
	...
	<style><cfinclude template="/mockbox/system/testing/reports/assets/css/simple.css"></style>
	<style>
	.dots{ font-size: 60px; clear: both; margin-bottom: 20px; }
	.dots span{ float: left; margin: -6px;}
	</style>
	<script><cfinclude template="/mockbox/system/testing/reports/assets/js/jquery.js"></script>
	<script>
