...
*/
component extends="mockbox.system.testing.BaseSpec"{
...
/*********************************** RUNNER Methods ***********************************/
	...
	*/
	remote function runTestRemote(any testMethod="", boolean debug=false, output="simple") output=true{
		...
		var runner = new mockbox.system.testing.TestBox( bundles="#getMetadata( this ).name#", reporter=arguments.output );
