			...
			<cfset this[ "getGender" ] = variables[ "getGender" ]> 
			<cffunction name="getGender" access="public" output="no" returntype="numeric">

			<cfset var results = this._mockResults>
			<cfset var resultsKey = "getGender">
			...
			<cfset arrayAppend(this._mockCallLoggers["getGender"], arguments)>
